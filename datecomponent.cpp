...
DateComponent::DateComponent(QWidget *parent) : QWidget(parent)
{
...
void DateComponent::localeChanged(int index)
{
...
//! [1]
void DateComponent::firstDayChanged(int index)
{
...
//! [2]
void DateComponent::selectedDateChanged()
{
...
//! [3]
void DateComponent::minimumDateChanged(const QDate &date)
{
...
//! [4]
void DateComponent::maximumDateChanged(const QDate &date)
{
...
//! [5]
void DateComponent::weekdayFormatChanged()
{
...
//! [6]
void DateComponent::weekendFormatChanged()
{
    QTextCharFormat format;
...
//! [7]
void DateComponent::reformatHeaders()
{
...
//! [8]
void DateComponent::reformatCalendarPage()
{
...
//! [9]
void DateComponent::createPreviewGroupBox()
{
...
//! [10]
void DateComponent::createGeneralOptionsGroupBox()
{
...
//! [13]
void DateComponent::createDatesGroupBox()
{
...
//! [16]
void DateComponent::createTextFormatsGroupBox()
{
...
//! [20]
QComboBox *DateComponent::createColorComboBox()
{
